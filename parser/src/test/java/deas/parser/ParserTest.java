...
public class ParserTest {
   ...
   void testBasicNumericalValue(int number, String string){
    ASTNode expected = new ASTNode(number);
   ...
   void testMaxIntNumericalValue(){
    ...
    ASTNode expected = new ASTNode(Integer.MAX_VALUE);
   ...
   @DisplayName("VjjShould pass through Java Integer.MIN_VALUE to the AST")
   void testMinIntNumericalValue(){

    ASTNode expected = new ASTNode(Integer.MIN_VALUE);
